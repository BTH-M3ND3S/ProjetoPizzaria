...
const Cardapio = () => {
    ...
    async function adicionarAoTicket(produto) {
        try {
            ...
            {!vizuticket ? <></> :
                <View style={styles.ticketContainer}>
                    ...
                    <View style={{ display: "flex", flexDirection: "row" }}>
                        <TouchableOpacity onPress={cleanTicket} style={{ width: 200, height: 50, backgroundColor: "gray", alignItems: "center", justifyContent: "center" }}>
