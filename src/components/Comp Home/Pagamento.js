...
export default function Pagamento({ handle }) {
    ...
    const { saldo, setSaldo, setTotalTicket } = useContext(UserContext);
    ...
    function EfetuarPagamento() {
        if (saldocontaselect) {
            if (saldo >= TotalTicket) {
                ...
                setTotalTicket(0); // Zera o TotalTicket
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.Pixdiv}>
                    <RadioButton
                        value={pixselect}
                        status={pixselect ? 'checked' : 'unchecked'}
                        onPress={() => {
                ...
                <View style={styles.Cartaodiv}>
                    <RadioButton
                        value={cartaoselect}
                        status={cartaoselect ? 'checked' : 'unchecked'}
                        onPress={() => {
                ...
                <View style={styles.SaldoContadv}>
                    <RadioButton
                        ...
                        status={saldocontaselect ? 'checked' : 'unchecked'}
                        onPress={() => {
