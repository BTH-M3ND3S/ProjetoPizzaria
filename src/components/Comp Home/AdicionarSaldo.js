...
export default  function AdicionarSaldo( {handle} ) {
  ...
  return (
    <View style={styles.Container}>
      ...
      <TextInput value={saldoteste} onChangeText={(text) => setSaldoTeste(text)} keyboardType='numeric' textContentType='telephoneNumber' style={{ height: 40, width: 300, borderColor: 'gray', borderWidth: 1, marginTop: 20, padding: 10, color: "white" }} placeholder='0' placeholderTextColor={'white'}/>
      <TouchableOpacity>
